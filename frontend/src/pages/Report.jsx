...
const Config = () => {
  ...
  const lin = (color) => {
    return (
      <div className="flex flex-col space-y-1 text-xs">
        ...
        <div className="grid min-w-0 flex-1 gap-x-4 grid-cols-11">
          { sizes.map(size => 
            <div>
              <div className={`bg-${color}-${size} h-10 w-full rounded`} />
              <p className="w-6 text-center w-full">{size}</p>
            </div>
          ) }
        </div>
      </div>
  ...
  return (
    <div className="bg-white dark:bg-gray-900 grid grid-cols-1 gap-4 px-8 py-4 overflow-y-auto w-full h-full">

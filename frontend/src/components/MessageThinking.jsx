const MessageThinkingm = ({model}) => {
  return (
    <div className="flex items-start gap-4">
      ...
      <div className="bg-blue-100 text-gray-900 rounded-full px-4 py-2 flex items-center gap-2.5 animate-pulse shadow-sm border border-blue-300">
        ...
        <p className="text-xs font-bold">
          <label className="uppercase">{model}</label> is thinking...
        </p>
      </div>
    </div>
  )

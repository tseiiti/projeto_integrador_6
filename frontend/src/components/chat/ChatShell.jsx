        ...
        <div className="bg-white rounded-2xl p-1 border border-gray-300 dark:border-zinc-700 dark:bg-zinc-900 focus-within:border-blue-500 transition-all duration-500 shadow-[0_8px_30px_rgba(0,0,0,0.1)] focus-within:shadow-[0_8px_30px_rgba(0,0,0,0.3)]">
          <div className="flex items-center gap-2 px-1.5 py-1">
            ...
            <div className="flex items-center gap-1 mb-0.5">
              <button className="ml-2 w-10 h-10 rounded-xl bg-blue-600 text-white cursor-pointer flex items-center justify-center shadow-lg shadow-blue-100 dark:shadow-gray-700 hover:bg-blue-500 hover:scale-105 active:scale-95 transition-all" title="Enviar"
                onClick={handleSend}>
